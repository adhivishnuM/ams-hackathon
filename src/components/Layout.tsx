    ...
    return (
        <div className="min-h-screen bg-background overflow-x-hidden">
            ...
            {showSidebar && (
                ...
                >
                    ...
                    <div className={cn(
                        ...
                        {!collapsed && (
                            <div className="min-w-0 animate-in fade-in slide-in-from-left-2 duration-500">
                                ...
                                <p className="text-[10px] text-primary font-bold uppercase tracking-widest mt-1 opacity-80">Professional AI</p>
                            </div>
                        )}
                    </div>
                    ...
                    <nav className={cn('flex-1 py-8 space-y-1.5 transition-all duration-300', collapsed ? 'px-2' : 'px-4')}>
                        {!collapsed && (
                            <p className="text-[10px] font-black text-muted-foreground/40 uppercase tracking-[0.2em] px-3 pb-4">Menu System</p>
                        )}
                    ...
                    <div className={cn('border-t border-border/20 py-6 flex flex-col gap-3', collapsed ? 'px-2' : 'px-4')}>
                        ...
                        >
                            ...
                            {!collapsed && <span className="uppercase tracking-[0.1em]">Collapse View</span>}
                        </button>
                    </div>
                </aside>
            )}
            ...
            <main className={cn(
                ...
                {mobileView ? (
                    <div className="min-h-screen bg-[#f0f4f0] flex items-center justify-center py-10">
                        <div
                            className="relative bg-background rounded-[48px] overflow-hidden shadow-[0_40px_100px_rgba(0,0,0,0.15)] border-8 border-slate-900"
                            style={{ 
                                width: 414, 
                                height: 860,
                                maxHeight: '90vh',
                        ...
                        >
                            ...
                            <div className="sticky top-0 z-50 flex items-center justify-center h-8 bg-background">
                                <div className="w-32 h-6 bg-slate-900 rounded-b-3xl absolute top-0" />
                            </div>

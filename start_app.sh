...
python3 -m pip install -r backend_py/requirements.txt --quiet --break-system-packages --user 2>/dev/null || python3 -m pip install -r backend_py/requirements.txt --quiet --break-system-packages
